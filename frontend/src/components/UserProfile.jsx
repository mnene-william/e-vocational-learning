...
function UserProfile() {
  ...
  const getAvatarUrl = (customUrl) => {
    ...
    return customUrl || "/default-avatar.png"; //here I am using my default image that you can find the the public folder of my frontend
  };

  // Here I am only showing that lessons the user has started or completed, not the one he has not interacted with
  const userProgress =
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      {profile && (
        <>
          {/* This is the Header of my UserProfile page/component */}
          ...
          {/* The card that show the user's progress */}
