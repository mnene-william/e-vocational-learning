    ...
    <>
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center space-y-6 animate-fade-in-up">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-4">
            <button
              ...
              className="bg-indigo-500 hover:bg-indigo-600 text-white px-6 py-3 rounded-lg font-semibold transition transform hover:scale-105"
            >
              Get Started
            </button>
      ...
      <section className="py-16 bg-gray-50 text-gray-900">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold text-center mb-12">Explore Skills</h2>
